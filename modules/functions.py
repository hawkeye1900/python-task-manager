...
# When a Python file is executed directly, the value of __name__ is set to
# "__main__".
# This can be used to control what parts of a file run when file is called as
# a module
# or when it is called directly
if __name__ == "__main__":
    # if functions module is run directly, its __name__ variable is set
    # to __main__
